...
class SwinTransformerV2(ModelBase):
    ...
    def __init__(self, model_config):
        super(SwinTransformerV2, self).__init__(model_config)
        
        #self._config['preprocess_func'] = 'tensorflow.keras.applications.imagenet_utils.preprocess_input'
        
        from keras_cv_attention_models import swin_transformer_v2

        self.model = swin_transformer_v2.SwinTransformerV2Tiny_window16(pretrained='imagenet' if self.use_imagenet_weights else None,
